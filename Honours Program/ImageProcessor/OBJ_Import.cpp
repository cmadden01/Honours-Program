// (c) Daniel Livingstone 2013 (determineFaceFormat, getFace, addVertex and loadObj)
#include "stdafx.h"
...
void OBJ_Import::loadObj(const char* filename, std::vector<GLfloat> &verts, std::vector<GLfloat> &norms,
...
char* OBJ_Import::loadFile(const char *fname, GLint &fSize)
{
	return fileLoader::loadFile(fname, fSize);
}
